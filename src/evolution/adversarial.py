...
class AdversarialRiskFitness:
    ...
    def is_turtle_gene(self, risk_genome: dict) -> bool:
        ...
        if dd_response.get('5%', {}).get('action') in ('emergency_exit', 'reduce_half'):
            return True
        return False
...
class ImmuneMemory:
    ...
    def record(self, risk_genome_id: str, crisis_type: str,
    ...
    def run_cycle(self) -> dict:
        ...
        for risk in risk_genomes:
            ...
            for crisis in attack_crises:
                mc_result = self.mc_tester.test(
                    {'risk': risk}, crisis, iterations=100
                )
                ...
                if mc_result['survival_probability'] > 0.7:
                    self.immune_memory.record(
                        ...
                        'survived', mc_result['survival_probability']
                    )
