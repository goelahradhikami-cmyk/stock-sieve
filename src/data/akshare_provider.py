...
class AkshareProvider:
    ...
    def fetch_period(self, report_date: str) -> int:
        ...
        try:
                ...
                for _, row in bal_df.iterrows():
                    ...
                    bal_map[code] = {
                        ...
                        "total_liabilities": _to_float(
                            row.get("负债-总负债") or row.get("负债合计") or row.get("负债总计")
                        ),
            ...
            for code in all_codes:
                ...
                debt_to_equity = (
                    (total_liab / equity) if (total_liab and equity and equity != 0) else None
                )
    ...
    def get_financial_dict(self, code: str) -> dict:
        ...
        return {
            ...
            "roa": (net_profit / d["total_assets"])
            if (net_profit and d.get("total_assets"))
            else None,
