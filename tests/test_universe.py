...
def test_filter_exclude_st():
    sample = pd.DataFrame([
        {"security_id": "000001.SZ", "code": "000001", "exchange": "SZ",
         "status": "active", "is_st": 0, "avg_amount_20d": 10000},
        {"security_id": "000002.SZ", "code": "000002", "exchange": "SZ",
         "status": "active", "is_st": 1, "avg_amount_20d": 20000},
    ])
...
def test_filter_liquidity():
    sample = pd.DataFrame([
        {"security_id": "000001.SZ", "code": "000001", "exchange": "SZ",
         "status": "active", "is_st": 0, "avg_amount_20d": 10000},
        {"security_id": "000003.SZ", "code": "000003", "exchange": "SZ",
         "status": "active", "is_st": 0, "avg_amount_20d": 3000},
    ])
...
def test_filter_exclude_bj():
    sample = pd.DataFrame([
        {"security_id": "000001.SZ", "code": "000001", "exchange": "SZ",
         "status": "active", "is_st": 0, "avg_amount_20d": 10000},
        {"security_id": "830001.BJ", "code": "830001", "exchange": "BJ",
         "status": "active", "is_st": 0, "avg_amount_20d": 10000},
    ])
...
def test_security_master():
    ...
    try:
        ...
        master.upsert([{
            "security_id": "600519.SH", "code": "600519", "exchange": "SH",
            "name": "贵州茅台", "status": "active", "is_st": 0, "total_mv": 25000,
        }])
...
def test_universe_filter_stats():
    sample = pd.DataFrame([
        {"security_id": f"{i:06d}.SZ", "code": f"{i:06d}", "exchange": "SZ",
         "status": "active", "is_st": 0, "avg_amount_20d": 10000}
        for i in range(10)
    ])
    f = UniverseFilter()
